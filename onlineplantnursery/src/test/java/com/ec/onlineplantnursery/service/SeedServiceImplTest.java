...
class SeedServiceImplTest {
	...
	void testSaveSeed() {
		Seed input = new Seed("Mango","Morning", "Twice a day", "easy","25ºC","Monocotyledonous",
				"This seed is a small embryonic plant",200,300,2000);
		Seed output = new Seed("Mango","Morning", "Twice a day", "easy","25ºC","Monocotyledonous",
				"This seed is a small embryonic plant",200,300,2000);	
	...
	void testGetAllSeeds() {
		...
		Seed s1 = new Seed("Mango","Morning", "Twice a day", "easy","25ºC","Monocotyledonous",
				"This seed is a small embryonic plant",200,300,2000);
		Seed s2 = new Seed("Papaya","Morning", "Twice a day", "easy","25ºC","Monocotyledonous",
				"This seed is a small embryonic plant",200,300,2000);
	...
	void testViewSeedById() throws SeedIdNotFoundException{
		Seed s = new Seed("Mango","Morning", "Twice a day", "easy","25ºC","Monocotyledonous",
				"This seed is a small embryonic plant",200,300,2000);
		s.setSeedId(1);
	...
	@Test
	//@Disabled
	@DisplayName("Test-Exception Delete seed")
	void testExceptionDeleteSeed() throws SeedIdNotFoundException {
		
		Seed input = new Seed("Mango","Morning", "Twice a day", "easy","25ºC","Monocotyledonous",
				"This seed is a small embryonic plant",250,300,2000);
		input.setSeedId(1);
		when(seedRepo.findById(2)).thenReturn(Optional.of(input));
		Executable executable = () ->seedService.deleteSeed(input);
		assertThrows(SeedIdNotFoundException.class, executable);
	}
	...
	void testUpdateSeed() throws SeedIdNotFoundException {
		Seed input = new Seed("Mango","Morning", "Twice a day", "easy","25ºC","Monocotyledonous",
				"This seed is a small embryonic plant",250,300,2000);
		input.setSeedId(1);
		Seed savedInput = new Seed("Mango","Evening", "Twice a day", "easy","25ºC","Monocotyledonous",
				"This seed is a small embryonic plant",250,300,2000);
	...
	@Test
	//@Disabled
	@DisplayName("Test-Exception Update seed")
	void testExceptionUpdateSeed() throws SeedIdNotFoundException {
		Seed input = new Seed("Mango","Morning", "Twice a day", "easy","25ºC","Monocotyledonous",
				"This seed is a small embryonic plant",250,300,2000);
		input.setSeedId(1);
		when(seedRepo.findById(2)).thenReturn(Optional.of(input));
		Executable executable = () ->seedService.updateSeed(input);
		assertThrows(SeedIdNotFoundException.class, executable);
	}
	}
